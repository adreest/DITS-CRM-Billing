package com.dits.crmbilling.admin;
...
public class AdminActivity extends Activity {
    private static final String START_URL = "https://billing.dits.com.pk/admin/";
    ...
    private void setupWebView() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                if (AdminActivity.this.filePathCallback != null) {
                    AdminActivity.this.filePathCallback.onReceiveValue(null);
                }
                ...
                try {
                    ...
                    AdminActivity.this.filePathCallback = null;
                    Toast.makeText(AdminActivity.this, "File chooser not available", Toast.LENGTH_LONG).show();
                    return false;
                }
                return true;
            }
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                try {
                    ...
                    dm.enqueue(request);
                    Toast.makeText(AdminActivity.this, "Download started", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
